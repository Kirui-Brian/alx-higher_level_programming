...
to ensure these attributes are valid integers. It also includes a public
class attribute to count the number of instances created, and methods
to calculate the area and perimeter of the rectangle and to print it using
the character '#'. It also includes a method to return a string representation
that can be used with eval(), and a message when an instance is deleted.
"""
